const _URL = "https://opentdb.com/api.php?amount=1&category=18&type=multiple";
...
async function appendData() {
  ...
  for (let i = 0; i < sorted.length - 1; i++) {
    question = new DOMParser().parseFromString(sorted[i], "text/html");
  }
  _questionHTML.textContent = answer.documentElement.textContent;
